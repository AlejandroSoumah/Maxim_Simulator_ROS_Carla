...
(defsystem "carla_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "CarlaRadarDetection" :depends-on ("_package_CarlaRadarDetection"))
    (:file "_package_CarlaRadarDetection" :depends-on ("_package"))
    (:file "CarlaRadarMeasurement" :depends-on ("_package_CarlaRadarMeasurement"))
    (:file "_package_CarlaRadarMeasurement" :depends-on ("_package"))
