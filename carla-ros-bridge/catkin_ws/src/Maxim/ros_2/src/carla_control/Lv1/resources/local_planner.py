...
import numpy as np
import copy
import resources.path_optimizer
import resources.collision_checker
import resources.velocity_planner
...
class LocalPlanner:
    def __init__(self, num_paths, path_offset, circle_offsets, circle_radii, 
        ...
        self._path_optimizer = resources.path_optimizer.PathOptimizer()
        self._collision_checker = \
           resources. collision_checker.CollisionChecker(circle_offsets,
                                               circle_radii,
                                               path_select_weight)
        self._velocity_planner = \
            resources.velocity_planner.VelocityPlanner(time_gap, a_max, slow_speed, 
                                             stop_line_buffer)
