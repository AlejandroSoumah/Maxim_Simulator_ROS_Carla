...
import resources.cutils
import numpy as np

class Controller2D(object):
    def __init__(self, waypoints):
        self.vars                   = resources.cutils.CUtils()
    ...
    def update_controls(self):
        ...
        self.vars.create_var('kp_heading', 3)
        self.vars.create_var('k_speed_crosstrack', 0.5)
        self.vars.create_var('cross_track_deadband', 1)
